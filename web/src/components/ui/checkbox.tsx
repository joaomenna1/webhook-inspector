...
interface CheckboxProps extends RadixCheckbox.CheckboxIndicatorProps {}
  ...
  return (
    <RadixCheckbox.Root
      className={twMerge(
        ...
        'focus-visible:outline-none in-focus-visible:ring-2 focus-visible:ring-400 focus-visible:ring-offset-2',
